...
class AsyncServiceHelper
{
    ...
    protected AsyncServiceHelper(String Version, Context AppContext, org.opencv.android.LoaderCallbackInterface Callback)
    {
    ...
    protected static void InstallService(final Context AppContext, final org.opencv.android.LoaderCallbackInterface Callback)
    {
        if (!mServiceInstallationProgress)
        {
                Log.d(TAG, "Request new service installation");
                org.opencv.android.InstallCallbackInterface InstallQuery = new org.opencv.android.InstallCallbackInterface() {
                private org.opencv.android.LoaderCallbackInterface mUserAppCallback = Callback;
                ...
                public void install() {
                    ...
                    else
                    {
                        ...
                        int Status = org.opencv.android.LoaderCallbackInterface.MARKET_ERROR;
                ...
                public void cancel()
                {
                    ...
                    int Status = org.opencv.android.LoaderCallbackInterface.INSTALL_CANCELED;
                    Log.d(TAG, "Init finished with status " + Status);
                    Log.d(TAG, "Calling using callback");
                    mUserAppCallback.onManagerConnected(Status);
                }
            ...
            Callback.onPackageInstall(org.opencv.android.InstallCallbackInterface.NEW_INSTALLATION, InstallQuery);
        }
        else
        {
            Log.d(TAG, "Waiting current installation process");
            org.opencv.android.InstallCallbackInterface WaitQuery = new org.opencv.android.InstallCallbackInterface() {
                private org.opencv.android.LoaderCallbackInterface mUserAppCallback = Callback;
                public String getPackageName()
                {
                    return "OpenCV Manager";
            ...
            Callback.onPackageInstall(org.opencv.android.InstallCallbackInterface.INSTALLATION_PROGRESS, WaitQuery);
        }
    }
        ...
        public void onServiceConnected(ComponentName className, IBinder service)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        Log.d(TAG, "Init finished with status " + org.opencv.android.LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION);
                        Log.d(TAG, "Unbind from service");
                        mAppContext.unbindService(mServiceConnection);
                        Log.d(TAG, "Calling using callback");
                        mUserAppCallback.onManagerConnected(org.opencv.android.LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION);
                        return;
                    }
                    ...
                    if ((null == path) || (path.length() == 0))
                    {
                        if (!mLibraryInstallationProgress)
                        {
                            org.opencv.android.InstallCallbackInterface InstallQuery = new org.opencv.android.InstallCallbackInterface() {
                                ...
                                public void install() {
                                    ...
                                    try
                                    {
                                        ...
                                        {
                                            Log.d(TAG, "OpenCV package was not installed!");
                                            Log.d(TAG, "Init finished with status " + org.opencv.android.LoaderCallbackInterface.MARKET_ERROR);
                                            Log.d(TAG, "Unbind from service");
                                            mAppContext.unbindService(mServiceConnection);
                                            Log.d(TAG, "Calling using callback");
                                            mUserAppCallback.onManagerConnected(org.opencv.android.LoaderCallbackInterface.MARKET_ERROR);
                                        }
                                    } catch (RemoteException e) {
                                        e.printStackTrace();;
                                        Log.d(TAG, "Init finished with status " + org.opencv.android.LoaderCallbackInterface.INIT_FAILED);
                                        Log.d(TAG, "Unbind from service");
                                        mAppContext.unbindService(mServiceConnection);
                                        Log.d(TAG, "Calling using callback");
                                        mUserAppCallback.onManagerConnected(org.opencv.android.LoaderCallbackInterface.INIT_FAILED);
                                    }
                                }
                                public void cancel() {
                                    Log.d(TAG, "OpenCV library installation was canceled");
                                    Log.d(TAG, "Init finished with status " + org.opencv.android.LoaderCallbackInterface.INSTALL_CANCELED);
                                    Log.d(TAG, "Unbind from service");
                                    mAppContext.unbindService(mServiceConnection);
                                    Log.d(TAG, "Calling using callback");
                                    mUserAppCallback.onManagerConnected(org.opencv.android.LoaderCallbackInterface.INSTALL_CANCELED);
                                }
                                public void wait_install() {
                                    Log.e(TAG, "Installation was not started! Nothing to wait!");
                                }
                            ...
                            mUserAppCallback.onPackageInstall(org.opencv.android.InstallCallbackInterface.NEW_INSTALLATION, InstallQuery);
                        }
                        else
                        {
                            org.opencv.android.InstallCallbackInterface WaitQuery = new org.opencv.android.InstallCallbackInterface() {
                            ...
                            mUserAppCallback.onPackageInstall(org.opencv.android.InstallCallbackInterface.INSTALLATION_PROGRESS, WaitQuery);
                        }
                        return;
                    }
                    else
                    {
                        ...
                        if (initOpenCVLibs(path, libs))
                        {
                            ...
                            status = org.opencv.android.LoaderCallbackInterface.SUCCESS;
                        }
                        else
                        {
                            Log.d(TAG, "First attempt to load libs fails");
                            status = org.opencv.android.LoaderCallbackInterface.INIT_FAILED;
                        }
